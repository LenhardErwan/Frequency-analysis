...
class Analyse {
    private:
        ...
        /**
         * @var std::string pahtIn
         * @brief string qui représente le chemin d'accès vers le fichier à analyser
         * 
         */
        std::string pathIn;
    ...
    public:
        ...
        /**
         * @brief Avoir le chemin vers le fichier à analyser
         * 
        ...
        /**
         * @brief Défini le chemin vers le fichier à analyser
         * 
         * @param _pathIn 
         */
